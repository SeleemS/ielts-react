...
function event(type, object) {
  return { id: `evt_${type}`, created: Math.floor(Date.now() / 1000), type, data: { object: { id: 'cs_test_default', lines: { data: [{ type: 'subscription', period: { start: 1790000000, end: PERIOD_END } }] }, created: Math.floor(Date.now() / 1000), ...object } } };
}
